            ...
            >
              <Button
                className={cn(
                  ...
                  inboxesCollapsed ? "size-10 px-0" : "flex-1 justify-center",
                )}
                onClick={() => {
        ...
        <div className="flex h-full min-h-0 flex-col">
                  ...
                  <>
                    <div className="flex items-center justify-between gap-3">
                      <div className="min-w-0">
                        ...
                        <p
                          className={cn("truncate text-xs", mailSoftTextClass)}
                        >
                    ...
                    <div className="mt-4 flex items-center gap-2">
                      ...
                      <Button
                        size="icon"
                        variant="ghost"
                        className={cn(mailGhostButtonClass, "rounded-[1rem]")}
                        onClick={() =>
                          selectedMailboxId
                      ...
                      >
                        <RefreshCwIcon
                          className={cn(loadingEmails ? "animate-spin" : "")}
                        />
                      </Button>
                    </div>
          ...
          <div className="flex-1 overflow-y-auto p-2.5">
            {!selectedMailbox ? (
              ...
              <p className={mailPlaceholderClass}>No messages for this view.</p>
            ) : (
              <div className="space-y-2">
                        ...
                        <div className="flex items-start gap-3 text-left">
                          ...
                          <div className="min-w-0 flex-1">
                            ...
                            <div className="mt-2 flex items-center gap-2 text-xs text-[color:var(--dashboard-text-soft)]">
                              ...
                              {email.kind === "sent" ? <span>Sent</span> : null}
                            </div>
                          </div>
                        </div>
                      )}
                ...
                <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
                  <div className="flex min-w-0 items-center gap-3">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className={cn("truncate text-xs", mailSoftTextClass)}>
